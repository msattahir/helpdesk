@php
    $label_p = "Item Distribution Details";
@endphp
                    ...
                    <table class="table table-lg table-bordered table-align-middle card-table">
                        <tbody class="thead-light">
                            <tr>
                                ...
                                <td>
                                    <span class="d-block h5 mb-0">
                                        {{@$data->distribute_item_name}}
                                    </span>
                                    {{@$data->distribute_item_model}}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="d-block h5 mb-0">
                                        {{integer_format(@$data->distribute_quantity)}}
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{date(
                                        "jS F, Y h:i:s",
                                        strtotime(@$data->distribute_time)
                                    )}}
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <ul class="list-group list-group-flush list-group-no-gutters">
                        ...
                        <li class="list-group-item pt-0">
                            <div class="d-flex justify-content-between align-items-center pb-2">
                                <h3>Distributed to:</h3>
                            </div>
                            <ul class="list-unstyled list-py-2 text-body">
                                <li>
                                    <i class="bi-person-badge me-2"></i>
                                    <span class="h5 mb-0">
                                        {{@$data->distribute_staff_no}}
                                    </span>
                                </li>
                                <li>
                                    <i class="bi-person me-2"></i>
                                    {{@$data->distribute_staff_name}}
                                </li>
                                <li>
                                    <i class="bi-envelope me-2"></i>
                                    {{@$data->distribute_staff_email}}
                                </li>
                                <li>
